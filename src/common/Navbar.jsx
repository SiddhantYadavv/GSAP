...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-row justify-between z-50 fixed top-0 w-full">
      ...
      <div onMouseEnter={() => {
        ...
        className="w-[16vw] h-12 bg-black relative">
        <div ref={hoverDiv} className="bg-[#D3FD50] h-0 w-full transition-all"></div>
        <div className=""> </div>
        <div className="w-full h-full flex justify-end pr-4 pt-2 text-2xl absolute top-0 z-10">
