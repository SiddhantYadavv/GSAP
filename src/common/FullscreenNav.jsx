  ...
  return (
    <div className="h-screen w-full bg-black z-10">
      <div id="fsnDiv" className="flex flex-row justify-between absolute top-0 w-full">
        ...
        <div onClick={() => setIsFullscreenNav(false)} className="pr-3" onMouseEnter={() => setStroke("#D3FD50")} onMouseLeave={() => setStroke("#ffffff")} >
          <svg className="hover:cursor-pointer" width="150px" height="150px" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
